...
RoomUi::RoomUi(std::string nameRoom, QWidget *parent) : QWidget(parent) {
    ...
    setUserMsg("elarif", "wesh les gars cavaaa");
...
void RoomUi::initaliseInfoRoom() {
    ...
    deleteButton->setIcon(QIcon("./client/assets/deleteImg.png"));
...
void RoomUi::setMsg(const std::string& nameUser, const std::string& msg) {
